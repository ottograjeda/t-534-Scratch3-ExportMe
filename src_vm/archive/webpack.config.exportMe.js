...
const base = {
    ...
    // use no optimization to get ES6 file
    // use optiomiztion to get ES5 file
    /* 
    optimization: {
        // new
        /* 
...
module.exports = [
    ...
    defaultsDeep({}, base, {
        ...
        output: {
            //libraryTarget: 'umd', // original ; just one line
            //libraryTarget: 'amd', // new - not used yet
            //name: "VirtualMachine",
            libraryTarget: "umd",
            //umdNamedDefine: true, // increases file size
    ...
    */
    ...
    defaultsDeep({}, base, {
        target: 'web',
        entry: {
            'benchmark-new-exportMe': './src/playground/benchmark-new-exportMe' 
